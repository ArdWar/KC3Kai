...
(function(){
	...
	window.KC3Meta = {
		...
		abyssShipBorderClass :function(ship){
			...
			// Abyssal Kai
			var kaiIds = [565, 566, 567, 616, 617, 618, 714, 715];
			if(kaiIds.indexOf(shipMaster.api_id) > -1){
				return "kai";
			}
			// Princesses and demons
			var bossIds = [539, 540, 544, 545, 546, 547, 548, 573, 574, 581, 582, 583, 584,
				 585, 586, 587, 588, 589, 590, 597, 598, 599, 600, 601, 602, 603, 604, 605,
				 606, 607, 608, 609, 610, 611, 612, 613, 619, 620, 625, 626, 627, 628, 629,
				 630, 631, 632, 633, 634, 635, 636, 641, 642, 643, 644, 645 ,646, 647, 648,
				 649, 650, 651, 652, 653, 654, 655, 656, 657, 658, 659, 660, 661, 662, 663,
				 664, 668, 669, 670, 671, 672, 673, 674, 675, 676, 677, 678, 679, 680, 681,
				 682, 683, 684, 685, 686, 687, 688, 689, 690, 691, 692, 693, 694, 695, 696,
				 697, 698, 699, 700, 701, 702, 703, 704, 705, 706, 707, 708, 709, 710, 711,
				 712, 713];
			if(bossIds.indexOf(shipMaster.api_id) >- 1){
				return "boss";
			}
